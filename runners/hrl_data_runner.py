...
def build_competitors(
    ...
    top_agents_2025 = _get_top5_std2025(tracker_log_dir, max_top=max_top_2025, track_only_penguin=track_only_penguin)
    top_agents_2024 = _get_top5_std2024(tracker_log_dir, max_top=max_top_2024, track_only_penguin=track_only_penguin)
...
def main():
    ...
    parser.add_argument("--track-only-penguin", action="store_true", help="仅追踪 PenguinAgent（其它参赛者不写 Tracker JSON，节省磁盘/解析开销）")
