...
try:
    ...
    negotiation_traces = []
    print(f"Warning: could not retrieve negotiation traces: {e}")
...
print("Agent, TotalProfit, Contracts, Bankrupt")
for a in agents:
    print(f"{a}, {profit[a]:.2f}, {contract_count[a]}, {'YES' if bankrupt[a] else 'NO'}")
